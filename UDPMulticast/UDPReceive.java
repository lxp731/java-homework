...
public class UDPReceive {
  ...
  public static void main(String[] args) throws IOException {
    ...
    MulticastSocket dgs = new MulticastSocket(8080);
    // 把dgs添加到组中
    dgs.joinGroup(InetAddress.getByName("224.1.0.8"));
    //    dgs.joinGroup(new InetSocketAddress(
    //            InetAddress.getByName("224.1.0.8"),
    //            8080,
